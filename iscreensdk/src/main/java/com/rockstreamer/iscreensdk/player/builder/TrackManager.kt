...
import com.rockstreamer.videoplayer.renderer.RendererTrackInfo
...
class TrackManager(context: Context) {
    ...
    var selector: DefaultTrackSelector = DefaultTrackSelector(context, selectionFactory)
    //val params = DefaultTrackSelector.ParametersBuilder().setMaxVideoSize(480, 360).build()
    val params = DefaultTrackSelector.ParametersBuilder().setMaxVideoBitrate(2800000).build()
